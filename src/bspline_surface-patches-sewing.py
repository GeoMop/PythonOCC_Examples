...
def main(file_name=None):
    ...
    patches = {}
    patches[(1, 1)] = {
        (1, 1): (1.0, 1.0, 0.5), (1, 2): (1.7, 1.0, 0.5), (1, 3): (2.3, 1.0, 0.0), (1, 4): (3.0, 1.0, 0.0),
        (2, 1): (1.0, 1.7, 0.5), (2, 2): (1.7, 1.7, 1.0), (2, 3): (2.3, 1.7, 0.0), (2, 4): (3.0, 1.7, 0.0),
        (3, 1): (1.0, 2.3, 0.0), (3, 2): (1.7, 2.3, 0.0), (3, 3): (2.3, 2.3, 0.0), (3, 4): (3.0, 2.3, 0.0),
        (4, 1): (1.0, 3.0, 0.0), (4, 2): (1.7, 3.0, 0.0), (4, 3): (2.3, 3.0, 0.0), (4, 4): (3.0, 3.0, 0.0)
    }
    patches[(1, 2)] = {
        (1, 1): (3.0, 1.0, 0.0), (1, 2): (5.0, 1.0, 0.0),
        (2, 1): (3.0, 3.0, 0.0), (2, 2): (5.0, 3.0, 0.0)
    }
    patches[(2, 1)] = {
        (1, 1): (1.0, 3.0, 0.0), (1, 2): (3.0, 3.0, 0.0),
        (2, 1): (1.0, 5.0, 0.0), (2, 2): (3.0, 5.0, 0.0)
    }
    patches[(2, 2)] = {
        (1, 1): (3.0, 3.0, 0.0), (1, 2): (4.0, 3.0, 0.0), (1, 3): (5.0, 3.0, 0.0),
        (2, 1): (3.0, 4.0, 0.0), (2, 2): (4.0, 4.0, 0.0), (2, 3): (5.0, 4.0, 0.0),
        (3, 1): (3.0, 5.0, 0.0), (3, 2): (4.0, 5.0, 0.0), (3, 3): (5.0, 5.0, 1.0)
    }
