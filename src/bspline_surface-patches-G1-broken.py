...
def main(file_name=None):
    ...
    patches = {}
    patches[(1, 1)] = {
        (1, 1): (1.0, 1.0, 0.0), (1, 2): (2.0, 1.0, 0.0), (1, 3): (3.0, 0.7,  0.0), (1, 4): (4.0, 1.0, 0.0),
        (2, 1): (1.0, 2.0, 0.0), (2, 2): (2.0, 2.0, 0.0), (2, 3): (3.0, 2.0, -0.7), (2, 4): (3.7, 2.0, 0.0),
        (3, 1): (1.0, 3.0, 0.0), (3, 2): (2.0, 3.0, 0.0), (3, 3): (3.6, 3.0, -0.7), (3, 4): (4.3, 3.0, 0.0),
        (4, 1): (1.0, 4.0, 0.0), (4, 2): (2.0, 4.0, 0.0), (4, 3): (3.0, 4.3,  0.0), (4, 4): (4.0, 4.0, 0.0)
    }
    patches[(1, 2)] = {
        (1, 1): (4.0, 1.0, 0.0), (1, 2): (5.0, 1.3, 0.0), (1, 3): (6.0, 1.0, 0.0), (1, 4): (7.0, 1.0, 0.0),
        (2, 1): (3.7, 2.0, 0.0), (2, 2): (5.7, 2.0, 2.0), (2, 3): (6.0, 2.0, 0.0), (2, 4): (7.0, 2.0, 0.0),
        (3, 1): (4.3, 3.0, 0.0), (3, 2): (6.3, 3.0, 2.0), (3, 3): (6.0, 3.0, 0.0), (3, 4): (7.0, 3.0, 0.0),
        (4, 1): (4.0, 4.0, 0.0), (4, 2): (5.0, 3.7, 0.0), (4, 3): (6.0, 4.0, 0.0), (4, 4): (7.0, 4.0, 0.0)
    }
