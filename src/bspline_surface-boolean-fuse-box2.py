...
def bezier_surfaces(filename=None):
    ...
    array7.SetValue(1, 1, gp_Pnt(-0.25, -0.50, 0.25))
    array7.SetValue(1, 2, gp_Pnt( 0.50, -0.50, 0.50))
    array7.SetValue(1, 3, gp_Pnt( 1.25, -0.50, 0.25))
    array7.SetValue(2, 1, gp_Pnt(-0.25,  0.00, 0.50))
    array7.SetValue(2, 2, gp_Pnt( 0.50,  0.00, 0.75))
    array7.SetValue(2, 3, gp_Pnt( 1.25,  0.00, 0.50))
    array7.SetValue(3, 1, gp_Pnt(-0.25,  0.50, 0.25))
    array7.SetValue(3, 2, gp_Pnt( 0.50,  0.50, 0.50))
    array7.SetValue(3, 3, gp_Pnt( 1.25,  0.50, 0.25))
