...
def main(file_name=None):
    ...
    patches = {}
    patches[(1, 1)] = {
        (1, 1): (1.00, 0.00, 0.00), (1, 2): (1.25, 0.500, 0.0), (1, 3): (1.00, 1.00, 0.0),
        (2, 1): (0.50, 0.25, 0.00), (2, 2): (0.50, 0.875, 0.0), (2, 3): (0.25, 1.25, 0.0),
        (3, 1): (0.00, 0.50, 1.00), (3, 2): (0.00, 1.250, 0.0), (3, 3): (0.00, 2.00, 0.0)
    }
    patches[(1, 2)] = {
        (1, 1): (2.00, 0.50, 1.00), (1, 2): (2.00, 1.250, 0.0), (1, 3): (2.00, 2.00, 0.0),
        (2, 1): (1.50, 0.25, 0.00), (2, 2): (1.50, 0.875, 0.0), (2, 3): (1.75, 1.75, 0.0),
        (3, 1): (1.00, 0.00, 0.00), (3, 2): (1.25, 0.500, 0.0), (3, 3): (1.00, 1.00, 0.0)
    }
    patches[(2, 1)] = {
        (1, 1): (2.00, 2.00, 0.0), (1, 2): (1.50, 2.250, 0.0), (1, 3): (1.0, 2.50, 1.0),
        (2, 1): (1.75, 1.75, 0.0), (2, 2): (1.00, 1.875, 0.0), (2, 3): (0.5, 2.25, 0.0),
        (3, 1): (1.00, 1.00, 0.0), (3, 2): (0.25, 1.250, 0.0), (3, 3): (0.0, 2.00, 0.0)
    }
