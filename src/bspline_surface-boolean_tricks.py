...
def bezier_surfaces(filename=None):
    ...
    array2.SetValue(1, 2, gp_Pnt( 0.5, 0.50, 0.6))
    array2.SetValue(1, 3, gp_Pnt( 0.5, 0.75, 0.5))
    array2.SetValue(2, 1, gp_Pnt(-0.5, 0.25, 0.5))
    array2.SetValue(2, 2, gp_Pnt(-0.5, 0.50, 0.6))
    array2.SetValue(2, 3, gp_Pnt(-0.5, 0.75, 0.5))
